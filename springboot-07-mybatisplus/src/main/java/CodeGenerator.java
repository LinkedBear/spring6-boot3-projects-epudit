...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/sring-dao?characterEncoding=utf8", "springboot", "123456")
                .globalConfig(builder -> {
                    builder.author("LinkedBear") // 设置代码的author
                            .outputDir("D://codegenerator"); // 指定输出目录
                })
                .packageConfig(builder -> {
                    builder.parent("com.linkedbear.springboot.mybatisplus") // 设置父包名
